...
Let's perform PCA to ensure that the data looks good.

```{r}
pca.counts <- prcomp(t(countData))
attributes(pca.counts)
summary(pca.counts$x)
plot(pca.counts$x[,1], pca.counts$x[,2], xlim=c(-300000,300000), ylim=c(-200000,100000), xlab="PC1", ylab="PC2",col=as.factor(colData$condition),pch=16)
