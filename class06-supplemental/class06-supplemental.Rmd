...
x <- read.pdb(x)
```
Moving onto step 3, let's generalize the code used to trim the PDB file to include only chain A.
...
Moving onto step 4, let's generalize the code used to describe *b factor* for atoms in chain A.
